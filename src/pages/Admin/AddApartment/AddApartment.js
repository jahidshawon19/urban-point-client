...
const AddApartment = () => {
    ...
    const handleSubmitApartment = e =>{
        ...
        const newApartment = {place, room, cost, apartmentType, image, shortDescription}

        fetch('https://enigmatic-hollows-67176.herokuapp.com/apartment', {
            method:'POST',
            headers:{
        ...
        <section className="py-5 bg-light">
            <div className="container">
                ...
                <div className="row">
                    ...
                    <form onSubmit={handleSubmitApartment}>
